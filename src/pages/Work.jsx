...
export default function Work() {
  return (
    <div className="work-page">
      {/* Hero Section */}
      <section className="work-hero section-padding">
        <div className="container text-center">
          <span className="inline-badge label-md mb-6">Our Work</span>
          <h1 className="h1 mb-8">Selected Work</h1>
      ...
      <section className="filters-section">
        <div className="container filters-container">
          <button className="filter-btn active label-md">All Projects</button>
          <button className="filter-btn label-md">UI/UX Design</button>
          <button className="filter-btn label-md">Web Development</button>
          <button className="filter-btn label-md">Branding</button>
        </div>
      </section>
      ...
      {/* Final CTA */}
      <section className="work-cta section-padding bg-surface-container-low">
        <div className="container text-center">
